...
void task_idle_animation(void *_)
{
    ...
    {
        display.clearDisplay();
        display.drawBitmap(CAR_POS_X, CAR_POS_Y, miata_idle_animation[frame % 2], 76, 23, SSD1306_WHITE);
        display.display();
        vTaskDelay(150 / portTICK_PERIOD_MS);
    }
    // display.clearDisplay();
    // display.drawBitmap(CAR_POS_X, CAR_POS_Y, miata_idle_0, 76, 23, SSD1306_WHITE);
    // display.display();
    // vTaskDelete(NULL);
}
...
void setup_display()
{
    ...
    if (display.begin(SSD1306_SWITCHCAPVCC, 0x3C))
    {
        ...
        xTaskCreate(task_animation, "idle_animation", 2048, NULL, 1, NULL);
        //  splash screen
        // display_large("miatamoto");
